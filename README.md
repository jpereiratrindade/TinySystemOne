...
- 🧠 **Resolução de Conflitos, Incerteza e OOD (v0.5.0)**:
  ...
  - **Noul**: atribuição diagnóstica do conflito / anomalia.
  - **Score**: grau contínuo de viabilidade ($\hat{\mu}$).
  - **Uncertainty**: variância heteroscedástica ($\hat{\sigma}^2$).
...
- [x] **v0.2**: Choice + Noul (atribuição diagnóstica) + Score contínuo calibrado (EXP-002)
